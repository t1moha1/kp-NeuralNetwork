...
namespace NN {
    class Layer {
        ...
        NN::ActivationFunctions::Activation activation;

    public:
        Layer(const Eigen::MatrixXd& weights, const Eigen::VectorXd& biases, NN::ActivationFunctions::Activation activation);
        Layer(int input_size, int output_size, NN::ActivationFunctions::Activation activation);
